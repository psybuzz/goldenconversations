/**
 * This file defines logic for the reset password page.
 */

var $submitForm = $('#submitForm');
var $passField = $('#submitForm input[name="newPassword"]');
var $passConfirmField = $('#submitForm input[name="newPasswordConfirm"]');
var $message = $('.message');
